<div class="space-y-6">
    ...
    <section class="panel p-4">
        <div class="grid gap-3 lg:grid-cols-[180px_180px_1fr]">
            <label class="block text-sm font-medium text-slate-700">Jenis baris<select wire:model.live="domain" class="mt-1 min-h-11 w-full rounded-xl border border-slate-300 px-3"><option value="">Semua jenis</option><option value="ggb">GGB</option><option value="syllabus">Silabus</option><option value="link">Relasi</option><option value="rpp">RPP</option></select></label>
