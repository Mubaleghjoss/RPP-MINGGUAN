    ...
    <div class="grid gap-5 p-4 xl:grid-cols-2 sm:p-5">
        ...
        <form wire:submit="saveCalendarEvent" wire:loading.attr="aria-busy" class="rounded-xl bg-white p-4 ring-1 ring-slate-200">
            ...
            <div class="mt-4 grid gap-3 sm:grid-cols-2">
                ...
                <label class="grid gap-1 text-sm font-medium text-slate-700">Judul<input type="text" wire:model.blur="calendarTitle" data-validation-field="calendarTitle" class="min-h-11 rounded-xl border border-slate-300 bg-white px-3" placeholder="Contoh: Ujian semester serentak">@error('calendarTitle')<span class="text-sm font-medium text-red-700" role="alert">{{ $message }}</span>@enderror</label>
                ...
                <label class="grid gap-1 text-sm font-medium text-slate-700 sm:col-span-2">Keterangan detail<textarea wire:model="calendarDetails" data-validation-field="calendarDetails" rows="3" class="rounded-xl border border-slate-300 bg-white px-3 py-2" placeholder="Keterangan yang akan tampil pada preview dan Excel"></textarea>@error('calendarDetails')<span class="text-sm font-medium text-red-700" role="alert">{{ $message }}</span>@enderror</label>
            </div>
